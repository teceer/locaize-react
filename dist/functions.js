...
function clc(strings) {
    ...
    (0, react_1.useEffect)(function () {
        ...
        var loadTranslation = function () { return __awaiter(_this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    }, __spreadArray([strings, language], values, true)); // Re-run when strings, language, or values change
    return translated;
}
// Usage examples:
// Server-side:
